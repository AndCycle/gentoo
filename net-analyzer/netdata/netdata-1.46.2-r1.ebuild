...
inherit cmake fcaps linux-info python-single-r1 systemd
...
SLOT="0"
IUSE="aclk bpf cloud cups +dbengine ipmi mongodb mysql nfacct nodejs postgres prometheus +go +python systemd tor xen"
...
pkg_postinst() {
	...
	if use go ; then
		fcaps 'cap_net_raw,cap_net_admin,cap_dac_read_search' 'usr/libexec/netdata/plugins.d/go.d.plugin'
	fi
}
